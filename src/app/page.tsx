...
function Role({ role }: { role: Role }) {
  return (
    <li className="flex gap-4">
      ...
      <dl className="flex flex-auto flex-wrap gap-y-1">
        ...
        {role.positions.map((position, index) => {
          ...
          const endLabel =
            typeof position.end === 'string' ? position.end : position.end.label
          const endDate =
            typeof position.end === 'string'
              ? position.end
...
function Resume() {
  let resume: Array<Role> = [
    {
      ...
      positions: [
        ...
        {
          title: 'Mid-Level Technical Support',
          start: '2018',
          end: '2020',
        },
        {
    ...
    },
    {
      ...
      positions: [
        {
          title: 'Internship Technical Support',
          start: '2013',
          end: '2014',
        },
      ],
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="/Luciano_Resume_Updated.pdf"
        download
        target="_blank"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Product designer focused on crafting software experiences.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            Im Luciano Silva, a product designer and entrepreneur based in
            Brazil, with more than 10 years of experience in the tech industry.
          </p>
