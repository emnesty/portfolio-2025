...
// } & HTMLMotionProps<'div'>) {
//   // Renomeamos para cardRef para não conflitar com o ref do Motion
...
//       return 1
//     }
//   }, [cardRef, bounds.width, bounds.left, bounds.right])
...
//             </TestimonialCard>
//           ))}
//           {/* "Espaço em branco" para permitir scroll extra no final */}
...
//                 onClick={() => scrollTo(testimonialIndex)}
//                 className="relative"
//                 aria-label={`Scroll para o depoimento de ${name}`}
//               >
//                 <motion.div
//                   animate={{
